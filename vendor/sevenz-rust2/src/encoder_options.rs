...
impl LzmaOptions {
    ...
    #[allow(missing_docs)]
    pub fn set_num_fast_bytes(&mut self, num_fast_bytes: u32) {
        let num_fast_bytes = num_fast_bytes.clamp(lzma_rust2::LzmaOptions::NICE_LEN_MIN, lzma_rust2::LzmaOptions::NICE_LEN_MAX);
        self.0.nice_len = num_fast_bytes;
    }

    #[allow(missing_docs)]
    pub fn set_lc(&mut self, lc: u32) {
        self.0.lc = lc.min(8);
    }

    #[allow(missing_docs)]
    pub fn set_lp(&mut self, lp: u32) {
        self.0.lp = lp.min(4);
    }

    #[allow(missing_docs)]
    pub fn set_pb(&mut self, pb: u32) {
        self.0.pb = pb.min(4);
    }

    #[allow(missing_docs)]
    pub fn set_mode_normal(&mut self) {
        self.0.mode = lzma_rust2::EncodeMode::Normal;
    }

    #[allow(missing_docs)]
    pub fn set_mode_fast(&mut self) {
        self.0.mode = lzma_rust2::EncodeMode::Fast;
    }

    #[allow(missing_docs)]
    pub fn set_match_finder_bt4(&mut self) {
        self.0.mf = lzma_rust2::MfType::Bt4;
    }

    #[allow(missing_docs)]
    pub fn set_match_finder_hc4(&mut self) {
        self.0.mf = lzma_rust2::MfType::Hc4;
    }
}
