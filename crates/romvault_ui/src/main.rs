...
struct RomVaultApp {
    ...
    pub(crate) tree_stats_active: Option<crate::tree::TreeStatsActive>,
    db_cache_dirty: bool,
    ...
    task_worker_handle: Option<std::thread::JoinHandle<crate::app_actions::TaskOutcome>>,
    task_selection_chain: Vec<String>,
    task_queue: std::collections::VecDeque<crate::app_actions::QueuedTask>,
    task_control: Option<ProcessControl>,
