...
fn test_tree_icon_idx_from_report_status_treats_unknown_as_grey_icon() {
    assert_eq!(
        tree_icon_idx_from_report_status(rv_core::enums::ReportStatus::Unknown),
        4
    );
}
...
fn test_tree_icon_idx_from_report_status_treats_ignore_as_grey_icon() {
    assert_eq!(
        tree_icon_idx_from_report_status(rv_core::enums::ReportStatus::Ignore),
        4
    );
}
...
fn test_tree_icon_idx_from_report_status_treats_merged_as_grey_icon() {
    assert_eq!(
        tree_icon_idx_from_report_status(rv_core::enums::ReportStatus::NotCollected),
        4
    );
}
...
fn test_tree_icon_idx_from_report_status_treats_corrupt_as_red_icon() {
    assert_eq!(
        tree_icon_idx_from_report_status(rv_core::enums::ReportStatus::Corrupt),
        1
    );
}
...
fn test_tree_icon_idx_from_report_status_treats_in_to_sort_as_special_icon() {
    assert_eq!(
        tree_icon_idx_from_report_status(rv_core::enums::ReportStatus::InToSort),
        4
    );
}
