...
/// Core header identification logic.
///
    ...
    fn get_detectors() -> Vec<Detector> {
        vec![
            ...
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![0x37, 0x7A, 0xBC, 0xAF, 0x27, 0x1C],
                },
            },
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![0x52, 0x61, 0x72, 0x21, 0x1A, 0x07, 0x00],
                },
            },
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![0x4D, 0x43, 0x6F, 0x6D, 0x70, 0x72, 0x48, 0x44],
                },
            },
            Detector {
                ...
                data: Data {
                    offset: 1,
                    value: vec![0x41, 0x54, 0x41, 0x52, 0x49, 0x37, 0x38, 0x30, 0x30],
                },
            },
            Detector {
                ftype: HeaderFileType::A7800,
                ...
                data: Data {
                    offset: 100,
                    value: vec![
                        0x41, 0x43, 0x54, 0x55, 0x41, 0x4C, 0x20, 0x43, 0x41, 0x52, 0x54, 0x20,
                        0x44, 0x41, 0x54, 0x41, 0x20, 0x53, 0x54, 0x41, 0x52, 0x54, 0x53, 0x20,
                        0x48, 0x45, 0x52, 0x45,
                    ],
                },
            },
            ...
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![
                        0x46, 0x44, 0x53, 0x1A, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x00, 0x00,
                    ],
                },
            },
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![
                        0x46, 0x44, 0x53, 0x1A, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x00, 0x00,
                    ],
                },
            },
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![
                        0x46, 0x44, 0x53, 0x1A, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x00, 0x00,
                    ],
                },
            },
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![
                        0x46, 0x44, 0x53, 0x1A, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x00, 0x00,
                    ],
                },
            },
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![
                        0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA, 0xBB, 0x02,
                    ],
                },
            },
            Detector {
            ...
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![0x50, 0x53, 0x49, 0x44, 0x00, 0x01, 0x00, 0x76],
                },
            },
            Detector {
                ftype: HeaderFileType::PSID,
                ...
                data: Data {
                    offset: 0,
                    value: vec![0x50, 0x53, 0x49, 0x44, 0x00, 0x03, 0x00, 0x7C],
                },
            },
            Detector {
                ftype: HeaderFileType::PSID,
                ...
                data: Data {
                    offset: 0,
                    value: vec![0x50, 0x53, 0x49, 0x44, 0x00, 0x02, 0x00, 0x7C],
                },
            },
            Detector {
                ftype: HeaderFileType::PSID,
                ...
                data: Data {
                    offset: 0,
                    value: vec![0x50, 0x53, 0x49, 0x44, 0x00, 0x01, 0x00, 0x7C],
                },
            },
            Detector {
                ftype: HeaderFileType::PSID,
                ...
                data: Data {
                    offset: 0,
                    value: vec![0x52, 0x53, 0x49, 0x44, 0x00, 0x02, 0x00, 0x7C],
                },
            },
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![0xAA, 0xBB, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00],
                },
            },
            Detector {
                ftype: HeaderFileType::SNES,
            ...
            Detector {
                ...
                data: Data {
                    offset: 0,
                    value: vec![
                        0x53, 0x4E, 0x45, 0x53, 0x2D, 0x53, 0x50, 0x43, 0x37, 0x30, 0x30, 0x20,
                        0x53, 0x6F, 0x75, 0x6E, 0x64, 0x20, 0x46, 0x69, 0x6C, 0x65,
                    ],
                },
            },
        ]
