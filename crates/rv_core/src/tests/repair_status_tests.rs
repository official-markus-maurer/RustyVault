    ...
    fn test_repair_status_count_helpers_do_not_double_count_mia_variants() {
        ...
        correct_mia.borrow_mut().set_rep_status(crate::enums::RepStatus::CorrectMIA);

        let missing_mia = Rc::new(RefCell::new(RvFile::new(FileType::File)));
        missing_mia.borrow_mut().set_rep_status(crate::enums::RepStatus::MissingMIA);
    ...
    fn test_repair_status_synthesizes_correctmia_only_branch_as_correct() {
        ...
        mia_rom.borrow_mut().set_rep_status(crate::enums::RepStatus::CorrectMIA);
        root.borrow_mut().child_add(mia_rom);

        let mut status = RepairStatus::new();
        status.report_status(Rc::clone(&root));

        assert_eq!(root.borrow().dir_status, Some(crate::enums::ReportStatus::Correct));
    }
    ...
    fn test_repair_status_synthesizes_mixed_correct_branch_as_unknown() {
        ...
        let correct_rom = Rc::new(RefCell::new(RvFile::new(FileType::File)));
        correct_rom.borrow_mut().set_rep_status(crate::enums::RepStatus::Correct);

        let unknown_rom = Rc::new(RefCell::new(RvFile::new(FileType::File)));
        unknown_rom.borrow_mut().set_rep_status(crate::enums::RepStatus::Unknown);
        ...
        assert_eq!(root.borrow().dir_status, Some(crate::enums::ReportStatus::Unknown));
    }
    ...
    fn test_repair_status_synthesizes_corrupt_only_branch_as_corrupt() {
        ...
        corrupt_rom.borrow_mut().set_rep_status(crate::enums::RepStatus::Corrupt);
        ...
        assert_eq!(status.roms_missing, 1);
        assert_eq!(root.borrow().dir_status, Some(crate::enums::ReportStatus::Corrupt));
    }
    ...
    fn test_repair_status_synthesizes_fix_and_corrupt_branch_as_corrupt() {
        ...
        fix_rom.borrow_mut().set_rep_status(crate::enums::RepStatus::NeededForFix);
    ...
    fn test_report_status_reset_invalidates_dir_status_recursively() {
        ...
        assert_eq!(root.borrow().dir_status, Some(crate::enums::ReportStatus::Unknown));
        assert_eq!(child.borrow().dir_status, Some(crate::enums::ReportStatus::Unknown));
    }
